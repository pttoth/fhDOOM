...
public:
	...
	virtual sysDllHandle_t	DLL_Load( const char *dllName );
	virtual void *			DLL_GetProcAddress( sysDllHandle_t dllHandle, const char *procName );
	virtual void			DLL_Unload( sysDllHandle_t dllHandle );
